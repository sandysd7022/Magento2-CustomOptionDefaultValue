...
namespace SD\CustomOptionDefaultValue\Block\Product\View\Options\Type\Select;
...
class Checkable extends AbstractOptions
{
     ...
     * @var string
     */
    protected $_template = 'SD_CustomOptionDefaultValue::product/composite/fieldset/options/view/checkable.phtml';
